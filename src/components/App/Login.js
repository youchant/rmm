...
import {Button, Row, Form, Icon, Card, Spin} from 'antd'
import {connect} from 'dva';
import FormItem from '../Common/FormItem';
import styles from './Login.less';
import mapping from '../../utils/mapping';

function Component({dispatch, logoSrc, appName, loading, schema, form}) {
...
function mapStateToProps({app, loading, personals}) {
  return {
    logoSrc: app.logoSrc,
    appName: app.name,
    schema: personals.schema,
    loading: loading.models.personals
  };
}
